    ...
    return (
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 py-12">
          ...
          <Link href="/hostels" className="mt-4 inline-block text-blue-600 hover:underline">
            ← Back to all hostels
          </Link>
        </div>
      </div>
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <Link href="/hostels" className="text-blue-600 hover:underline mb-4 inline-block">
          ← Back to all hostels
        </Link>
          ...
          <div className="p-6">
            <div className="flex justify-between items-start">
              ...
              <div className="flex items-center bg-green-100 px-3 py-1 rounded-full">
                ...
                <span className="text-base font-semibold text-green-600">{hostel.rating}</span>
              </div>
            </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="text-gray-600">{hostel.gender.charAt(0).toUpperCase() + hostel.gender.slice(1)}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="text-gray-600">₹{hostel.price}/{hostel.priceUnit}</p>
                    </div>
                  </div>
                ...
                <div className="bg-blue-50 p-4 rounded-lg">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-blue-600">{hostel.contact}</p>
                    </div>
                  </div>
